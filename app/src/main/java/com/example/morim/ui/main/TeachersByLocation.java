        ...
        mainViewModel.getTeachers()
                .observe(this, teachers -> {
                    ...
                    for (Teacher teacher : teachers) {
                        // if im a teacher dont show my teacher pos(it will show my localisation)
                        if (teacher.getId().equals(FirebaseAuth.getInstance().getUid())) {
                            continue;
                        }
...
@Override
public void onViewTeacher(Teacher teacher) {
    dialog.dismiss();

    Bundle bundle = new Bundle();
    bundle.putString("teacher", new Gson().toJson(teacher));
    findNavController().navigate(R.id.teacherFragment, bundle);
                ...
                @Override public void onShowComments(Teacher teacher) {
                    if (teacher.getComments() != null && !teacher.getComments().isEmpty()) {
                        RatingListDialog.showRatingListDialog(
                                teacher.getComments(),
                                getChildFragmentManager()
                        );
                    } else {
